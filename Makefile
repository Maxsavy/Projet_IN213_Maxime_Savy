...
SOURCES = pcfast.ml lambda.ml translate.ml pcfloop.ml
GENERATED = pcflex.ml pcfparse.ml pcfparse.mli
MLIS =
OBJS = pcfast.cmo pcfparse.cmo pcflex.cmo lambda.cmo translate.cmo pcfloop.cmo
...
pcfparse.ml pcfparse.mli: pcfparse.mly
	$(CAMLYACC) pcfparse.mly
